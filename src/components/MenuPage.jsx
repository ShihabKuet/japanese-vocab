 ...
 *   - Category filter
 *   - Romaji toggle
 *   - Navigation to Browse / Flashcards / Quiz
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 600, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", paddingTop: onHome ? 10 : 30, paddingBottom: 20 }}>
          ...
          <p style={{ color: "#7a4a2a", fontSize: 14, marginTop: 4, letterSpacing: 3 }}>
        ...
        <div style={{
          ...
          <div onClick={() => setShowRomaji(!showRomaji)}
            style={{ width: 44, height: 24, borderRadius: 12, background: showRomaji ? "#b5341a" : "#ccc", cursor: "pointer", position: "relative", transition: "background 0.3s" }}>
